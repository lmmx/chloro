...
|------|-----------|-----------|--------|-------|---------|------|
| 1 | 2 | 1 | 17.8% | 1,163 | 6,520 | [`hir/src_lib`](https://github.com/lmmx/chloro/blob/master/chloro-core/tests/conformance/snapshots/ra/hir/src_lib.diff) |

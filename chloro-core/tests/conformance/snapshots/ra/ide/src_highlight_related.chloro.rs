...
use ide_db::{
    ...
    for_each_tail_expr, full_path_of_name_ref,
    ...
    FxHashMap, FxHashSet, IdentClass}, ReferenceCategory, RootDatabase, SearchScope}, },
};
use syntax::{
    ast::{self,

    match_ast, AstNode, HasLoopBody},

    SyntaxKind::{self,

    SyntaxToken, TextRange, WalkEvent, IDENT, INT_NUMBER}, T,
};

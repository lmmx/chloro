...
use rustc_type_ir::{
    inherent::{IntoKind, Term as _}, AliasRelationDirection, FallibleTypeFolder, Flags, Interner,
...
use crate::next_solver::{
    ...
    util::PlaceholderReplacer, Binder, Const, ConstKind, DbInterner, Goal, ParamEnv, Predicate,

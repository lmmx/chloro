...
use rustc_type_ir::{
    error::ExpectedFound, inherent::{IntoKind, SliceLike, Span as _},
    lang_items::SolverTraitLangItem, solve::{Certainty, GoalSource, MaybeCause, NoSolution},
...
use crate::next_solver::{
    ...
    inspect::{self, ProofTreeVisitor}, normalize::deeply_normalize_for_diagnostics, AliasTerm,
    Binder, ClauseKind, Const, ConstKind, DbInterner, PolyTraitPredicate, PredicateKind,

...
use hir_def::{
    expr_store::{Body, path::Path}, hir::PatId, item_tree::FieldsShape, AdtId, EnumVariantId,
...
use crate::{
    db::HirDatabase, display::{HirDisplay, HirDisplayError, HirFormatter}, infer::BindingMode,
    next_solver::{GenericArgs, Mutability, Ty, TyKind}, InferenceResult,
};

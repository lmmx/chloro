...
use crate::{
    ...
    CallableSnippets, CompletionContext, CompletionItem, CompletionItemKind, CompletionRelevance,
    CompletionRelevanceFn, CompletionRelevanceReturnType, CompletionRelevanceTraitInfo, DotAccess,
    DotAccessKind, PathCompletionCtx, PathKind, }, }, },
};
...
mod tests {
    use crate::{
        check_edit, check_edit_with_config},

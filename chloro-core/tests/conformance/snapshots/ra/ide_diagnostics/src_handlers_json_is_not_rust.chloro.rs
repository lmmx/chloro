...
use ide_db::{
    ...
    source_change::SourceChangeBuilder, EditionedFileId, FileRange, FxHashMap, RootDatabase,
};
...
mod tests {
    use crate::{
        check_fix, check_no_fix}, tests::{check_diagnostics_with_config, DiagnosticsConfig,
    };
    #[test]

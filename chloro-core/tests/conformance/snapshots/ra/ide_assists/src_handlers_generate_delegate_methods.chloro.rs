...
use syntax::{
    ast::{
        self, edit::{AstNodeEdit, make, syntax_editor::Position, AstNode,
    HasGenericParams, HasName, HasVisibility as _, IndentLevel}, },
};

use crate::{
    find_struct_impl}, utils::{convert_param_list_to_arg_list, AssistContext, AssistId, AssistKind,
    Assists, GroupLabel,
};

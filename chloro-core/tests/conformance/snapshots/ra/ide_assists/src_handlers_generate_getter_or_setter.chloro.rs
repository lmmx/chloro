...
use syntax::{
    ast::{self, AstNode, HasName, HasVisibility, edit_in_place::Indent, make}, ted, TextRange,
};

use crate::{
    utils::{convert_reference_type, find_struct_impl, generate_impl}, AssistContext, AssistId,
    Assists, GroupLabel,
};

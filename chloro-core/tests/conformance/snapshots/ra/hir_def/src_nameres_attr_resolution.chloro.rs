...
use base_db::Crate;
use hir_expand::{
    attrs::{Attr, AttrId, AttrInput}, inert_attr_macro::find_builtin_attr_idx,
    mod_path::{ModPath, PathKind}, MacroCallId, MacroCallKind, MacroDefId,
};
...
use crate::{
    db::DefDatabase, item_scope::BuiltinShadowMode,
    nameres::{LocalDefMap, path_resolution::ResolveMode}, AstIdWithPath, LocalModuleId, MacroId,
    UnresolvedMacro,
};

...
use hir_def::{
    ...
    AdtId, GenericDefId, TraitFlags}, TypeOrConstParamData, TypeParamProvenance, TypeRef,
    TypeRefId}, WherePredicate},
};
use hir_ty::{
    db::HirDatabase,
    ...
    write_bounds_like_dyn_trait_with_prefix, write_visibility, HirDisplayError,
    HirDisplayWithExpressionStore, HirFormatter, SizedByDefault, },
};

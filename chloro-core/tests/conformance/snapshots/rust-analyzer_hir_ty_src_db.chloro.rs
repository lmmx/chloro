...
fn layout_of_adt<'db>(&'db self, def: AdtId, args: GenericArgs<'db>, trait_env: Arc<TraitEnvironment<'db>>) -> Result<Arc<Layout>, LayoutError>;
#[salsa::invoke(crate::layout::layout_of_ty_query)]
#[salsa::cycle(cycle_result = crate::layout::layout_of_ty_cycle_result)]
fn layout_of_ty<'db>(&'db self, ty: Ty<'db>, env: Arc<TraitEnvironment<'db>>) -> Result<Arc<Layout>, LayoutError>;
...
fn type_for_type_alias_with_diagnostics<'db>(&'db self, def: TypeAliasId) -> (EarlyBinder<'db, Ty<'db>>, Diagnostics);
...
fn impl_self_ty_with_diagnostics<'db>(&'db self, def: ImplId) -> (EarlyBinder<'db, Ty<'db>>, Diagnostics);
...
fn const_param_ty_with_diagnostics<'db>(&'db self, def: ConstParamId) -> (Ty<'db>, Diagnostics);
...
fn impl_trait_with_diagnostics<'db>(&'db self, def: ImplId) -> Option<(EarlyBinder<'db, TraitRef<'db>>, Diagnostics)>;
...
fn field_types_with_diagnostics<'db>(&'db self, var: VariantId) -> (Arc<ArenaMap<LocalFieldId, EarlyBinder<'db, Ty<'db>>>>, Diagnostics);
#[salsa::invoke(crate::lower::field_types_query)]
#[salsa::transparent]
fn field_types<'db>(&'db self, var: VariantId) -> Arc<ArenaMap<LocalFieldId, EarlyBinder<'db, Ty<'db>>>>;
#[salsa::invoke(crate::lower::callable_item_signature_query)]
fn callable_item_signature<'db>(&'db self, def: CallableDefId) -> EarlyBinder<'db, PolyFnSig<'db>>;
#[salsa::invoke(crate::lower::return_type_impl_traits)]
fn return_type_impl_traits<'db>(&'db self, def: FunctionId) -> Option<Arc<EarlyBinder<'db, ImplTraits<'db>>>>;
#[salsa::invoke(crate::lower::type_alias_impl_traits)]
fn type_alias_impl_traits<'db>(&'db self, def: TypeAliasId) -> Option<Arc<EarlyBinder<'db, ImplTraits<'db>>>>;
#[salsa::invoke(crate::lower::generic_predicates_without_parent_with_diagnostics_query)]
fn generic_predicates_without_parent_with_diagnostics<'db>(&'db self, def: GenericDefId) -> (GenericPredicates<'db>, Diagnostics);
...
fn generic_defaults_with_diagnostics<'db>(&'db self, def: GenericDefId) -> (GenericDefaults<'db>, Diagnostics);

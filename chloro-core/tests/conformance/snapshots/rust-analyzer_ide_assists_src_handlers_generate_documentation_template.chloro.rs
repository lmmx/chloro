...
pub(crate) fn generate_documentation_template(acc: &mut Assists, ctx: &AssistContext<'_>) -> Option<()> {
...
fn function_call(ast_func: &ast::Fn, param_list: &ast::ParamList, self_name: Option<&str>, is_unsafe: bool) -> Option<String> {
